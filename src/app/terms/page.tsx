        ...
        <div className='window-content'>
          ...
          <div className='p-4' style={{ border: "var(--inset-border)" }}>
            ...
            <ol className='text-sm mb-4 list-decimal pl-5 space-y-2'>
              ...
              <li>
                "이용자"란 회사의 서비스를 이용하는 모든 사용자를 의미합니다.
              </li>
              <li>
                "계정"이란 이용자가 서비스를 이용하기 위해 필요한 정보를
                의미합니다.
              </li>
            </ol>
            ...
            <p className='text-sm mb-4'>
              ...
              있습니다.
              <br />
              3. 회사가 약관을 변경할 경우, 변경된 약관의 내용과 시행일을
              명시하여 서비스 내에 공지합니다.
              <br />
              4. 이용자는 변경된 약관에 동의하지 않을 경우 서비스 이용을 중단할
              수 있으며, 계속 사용하는 경우 약관 변경에 동의한 것으로
              간주합니다.
            </p>
