    ...
    <div className='p-4'>
      ...
      <div className='p-4' style={{ border: "var(--inset-border)" }}>
        ...
        <div className='p-3 mb-4' style={{ border: "var(--inset-border)" }}>
          ...
          <p className='text-sm'>
            A: 네, 워터베어러의 기본 기능은 무료로 이용하실 수 있습니다. 다만
        ...
        <div className='p-3 mb-4' style={{ border: "var(--inset-border)" }}>
          ...
          <p className='text-sm'>
            A: 로그인 페이지에서 '비밀번호 찾기' 링크를 클릭하면, 가입 시 등록한
            이메일로 비밀번호 재설정 링크를 보내드립니다.
          </p>
        </div>
        <div className='p-3 mb-4' style={{ border: "var(--inset-border)" }}>
          <h3 className='bold text-sm mb-1'>Q: 계정 삭제는 어떻게 하나요?</h3>
          <p className='text-sm'>
        ...
        <div className='p-3 mb-4' style={{ border: "var(--inset-border)" }}>
          <h3 className='bold text-sm mb-1'>Q: 내 기록은 어떻게 보호되나요?</h3>
          <p className='text-sm'>
        ...
        <div className='p-3 mb-4' style={{ border: "var(--inset-border)" }}>
          <h3 className='bold text-sm mb-1'>Q: 데이터 백업은 어떻게 하나요?</h3>
          <p className='text-sm'>
            A: 설정 메뉴의 '데이터 관리'에서 모든 기록을 CSV 또는 JSON 형식으로
            내보내기할 수 있습니다. 정기적인 백업을 권장드립니다.
          </p>
        </div>
        ...
        <p className='text-sm mt-8'>
          ...
          페이지를 통해 추가 질문을 보내주시면 24시간 이내에 답변 드리겠습니다.
        </p>
      </div>
    </div>
  );
