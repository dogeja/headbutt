...
export default function Homepage() {
  return (
    <div className='p-4'>
      ...
      {/* 시작 윈도우 */}
      <div className='window mb-4 max-w-6xl mx-auto' style={{ height: "auto" }}>
        <div className='window-header'>
          <span>워터베어러</span>
          <div className='window-controls'>
            <button className='window-control'>─</button>
      ...
      {/* 서비스 소개 */}
      <div className='window mb-4 max-w-5xl mx-auto' style={{ height: "auto" }}>
        <div className='window-header'>
      ...
      <div
        ...
        style={{ height: "auto", overflow: "hidden", maxHeight: "none" }}
      >
        <div className='window-header'>
          <span>공지사항</span>
          <div className='window-controls'>
      ...
      {/* 환영 메시지 */}
      <div
        className='window max-w-3xl mx-auto'
        style={{ height: "auto", overflow: "hidden", maxHeight: "none" }}
      >
        <div className='window-header'>
          <span>환영합니다</span>
        ...
        <div
          className='window-content p-6 text-center'
          style={{
            minHeight: "0",
            height: "auto",
            overflow: "visible",
